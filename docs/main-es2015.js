...
let ConhecaNossanaveComponent = class ConhecaNossanaveComponent {
...
ConhecaNossanaveComponent.ctorParameters = () => [
...
let DialogCompraComponent = class DialogCompraComponent {
...
DialogCompraComponent.ctorParameters = () => [
...
let DialogLeadComponent = class DialogLeadComponent {
    constructor(dialogRef, data) {
        this.dialogRef = dialogRef;
        this.data = data;
    }
...
DialogLeadComponent.ctorParameters = () => [
    { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] }
];
...
let HomeComponent = class HomeComponent {
    ...
    ngOnInit() { }
    _panAndZoom(map, zoom_in, coordinates) {
    ...
    enviarLead() {
        ...
        this.email = "";
        const dialogRef = this.dialog.open(_dialog_lead_dialog_lead_component__WEBPACK_IMPORTED_MODULE_5__["DialogLeadComponent"], {
            data: { nome: "", email: "" },
        });
    }
};
...
let PerfilPlanetarioComponent = class PerfilPlanetarioComponent {
    constructor(formBuilder, db, dialog) {
    ...
    analisaQuiz(quiz) {
        let perfilVoe = 0;
        let perfilDescubra = 0;
        let perfilAventure = 0;
        let perfilConecte = 0;
...
PerfilPlanetarioComponent.ctorParameters = () => [
...
let RelatorioComponent = class RelatorioComponent {
    ...
    ngOnInit() {
        this.db.collection('compras').valueChanges().subscribe((compras) => {
            this.compras = compras;
        });
        this.db.collection('leads').valueChanges().subscribe((leads) => {
            this.leads = leads;
        });
        this.db.collection('quiz').valueChanges().subscribe((quiz) => {
            this.quiz = quiz;
        });
    }
};
...
let ResultadoQuizComponent = class ResultadoQuizComponent {
    constructor(dialogRef, data, dialog, db, router) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.dialog = dialog;
        this.db = db;
    ...
    queroComprar(planetaId) {
        this.onNoClick();
        const dialogRef = this.dialog.open(_dialog_compra_dialog_compra_component__WEBPACK_IMPORTED_MODULE_3__["DialogCompraComponent"], {
            data: {
                nome: '',
                email: '',
                incrementeSuaViagem: {
        ...
        dialogRef.afterClosed().subscribe(result => {
            ...
            this.router.navigate(['/']);
            this.db.collection('compras').add(Object.assign({}, result, { planetaId, dataInclusao: new Date() }));
        });
    }
};
ResultadoQuizComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
...
let SalvoComSucessoComponent = class SalvoComSucessoComponent {
    constructor(dialogRef) {
        this.dialogRef = dialogRef;
    }
    ngOnInit() {
...
SalvoComSucessoComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] }
];
